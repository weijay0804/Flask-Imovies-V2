...
if (url.indexOf('page') != -1)
{
    ...
    var xhr = get_datas_auth(`/api/v1/users/${header_datas.uid}/watched?page=${page}`, header_datas) // 使用 get 取得電影資料
}
else
{
    var xhr = get_datas_auth(`/api/v1/users/${header_datas.uid}/watched`, header_datas) // 使用 get 取得電影資料
}
